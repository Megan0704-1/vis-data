...
```bash
# @ root dir
# this scripts update image path for dinosaur data even types.
python update_silhouette_mapping.py --species-csv vis-data/data_preprocessed/dinosaurs_species_cards.csv --out-csv vis-data/data_preprocessed/dinosaurs_species_cards_images.csv --asset-base ./dino_images/images/dinos/
```
